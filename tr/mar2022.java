...
class thread extends Thread {
    ...
    public void run() {
        try {
            ...
            for (int i = 0; i < kMax; i++) {// qui anche se tutti i thread hanno fatto il codice di sopra non sono
                                            // usciti e finisce il programma no qui i thread arrivano in maniercasuale
                                            // proprio come se il codice di sopraNON ci fosse

                /// qui i thread vengono ancora non è che arrivano nella parte di codic sopra
